            ...
            >
              <div className="relative">
                <img
                  src={m.avatar}
                  alt={m.name}
                  className="h-32 w-32 rounded-full object-cover mx-auto border-4 border-white shadow-soft"
                />
                <a
                  href={m.linkedin}
                  aria-label="LinkedIn"
                  className="absolute right-6 bottom-0 h-8 w-8 rounded-full bg-brand-600 text-white grid place-items-center shadow-soft"
                >
                  in
                </a>
              </div>
